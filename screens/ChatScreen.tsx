import { ActivityIndicator, FlatList, ImageBackground, KeyboardAvoidingView, Platform, SafeAreaView, StyleSheet, Text, TextInput, TouchableNativeFeedback, TouchableOpacity, View, Image, Easing } from "react-native";
                            ...
                            <>
...

                                {
                                    messageText === "" ? (
                                        ...
                                        <TouchableOpacity onPress={sendMessageHandler} style={{ backgroundColor: colors.primary, width: 40, height: 40, ...styles.attachmentButton}} disabled={isLoading}>
